                ...
                <div class="header-right">
                    <ul class="clearfix">
                        <li class="icons dropdown"><a href="javascript:void(0)" data-toggle="dropdown">
                            ...
                            <div class="drop-down  dropdown-menu">
                                <div class="dropdown-content-heading d-flex justify-content-between">
                                    <span class="">{{ App\ContactForm::count() }} Messages</span>
                                ...
                                <div class="dropdown-content-body">
                                    <ul>
                                      @foreach (App\ContactForm::latest()->paginate(3) as $messages)
                        ...
                        <li class="icons dropdown"><a href="javascript:void(0)" data-toggle="dropdown">
                                ...
                                <span class="badge badge-pill gradient-2">{{ App\TicketBooking::where('payment_status', 1)->count() }}</span>
                            </a>
                            <div class="drop-down  dropdown-menu dropdown-notfication">
                                <div class="dropdown-content-heading d-flex justify-content-between">
                                    <span class="">{{ App\TicketBooking::where('payment_status', 1)->count() }}  Notifications</span>
                                </div>
                                <div class="dropdown-content-body">
                                    <ul>

                                      @forelse (App\TicketBooking::latest()->paginate(4) as $notifications)
                                        <li>
                                            <a href="javascript:void()">
